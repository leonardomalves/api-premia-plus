    ...
    public function store(Request $request): JsonResponse
    {
        try {
            $validated = $request->validate([
                ...
                'min_tickets_required' => 'required|integer|min:1|max:1000000',
                'status' => 'sometimes|in:pending,active,inactive,cancelled,completed',
    ...
    public function update(Request $request, string $uuid): JsonResponse
    {
        try {
            ...
            $validated = $request->validate([
                ...
                'min_tickets_required' => 'sometimes|required|integer|min:1|max:1000000',
                'status' => 'sometimes|in:pending,active,inactive,cancelled,completed',
                'notes' => 'nullable|string|max:2000',
            ]);
