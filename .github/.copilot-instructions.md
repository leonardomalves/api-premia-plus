...
- Sempre atulize a collection do postman com as novas rotas criadas no diretório docs, não precisar cirar uma nova caso exita, apenas atualize.
- Para cada feature crie uma nova collection do postman, separeas em diretórios por domínio (Users, Raffles, Commissions, etc) e atualize os exemplos de requisição e resposta, e separe de acordo com o ambiente(Local, develop, production).
...
- ✅ Strict typing em todos os arquivos PHP
- ✅ Sistema de traduções completo (90+ mensagens)
- ✅ JSON responses padronizados
- ✅ Middleware de API Key implementado
- ✅ FormRequests para validação
- ✅ Performance otimizada com cache
- ✅ API pública com rate limiting implementada
- ✅ Lead tracking com UTM parameters
- ✅ Collections Postman completas (10+ endpoints)
- ✅ Testes automatizados (6 testes de API pública)
